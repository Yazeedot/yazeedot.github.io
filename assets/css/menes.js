...
var agent=navigator.userAgent;var ios=agent.match(/.*; CPU (?:iPhone )?OS ([0-9_]*) like Mac OS X[;)]/);ios=ios==null?'6.0':ios[1].replace(/_/g,'.');var stylesheet=$("#stylesheet");if(ios.match(/^[78]($|\.)/)!=null){stylesheet.href("http://yazeedot.github.io/assets/css/ios78.css")}else{stylesheet.href("http://yazeedot.github.io/assets/css/fullwidth.css")}
*/
